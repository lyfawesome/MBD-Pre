...
- 一个 38 件的候选组被精确分成 29、8 和 1 件三类；零件 75/76 是精确镜像件，因无法由正旋转+平移重合而分开，诊断见 [docs/cases/MOTOR_PARTS_75_76.md](docs/cases/MOTOR_PARTS_75_76.md)。
- 21 个分组 STEP 全部回读合法，实际 Solid 合计 84，最大体积相对误差为 `3.65198169360252×10⁻⁸`。
